package com.thatnawfal.dicoding_advanceui_modul.widget
...
import com.thatnawfal.dicoding_advanceui_modul.widget.function.WidgetAction
...
class RandomNumberWidget : AppWidgetProvider() {
    ...
    private fun updateAppWidget(
        ...
        val widgetText = "Random: " + WidgetAction.generateNumber(100)
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (WIDGET_CLICK == intent.action) {
            ...
            val lastUpdate = "Random: " + WidgetAction.generateNumber(100)
    ...
    private fun getPendingSelfIntent(
        context: Context, appWidgetId: Int, action: String
    ) : PendingIntent {
